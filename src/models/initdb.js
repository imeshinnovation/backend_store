...
mariadb.createConnection({
    ...
    conexion.query("create table if not exists" + env.DATABASE + ".evento(id int(11) primary key not null auto_increment, id_evento int(11) not null, evento varchar(64) not null, create_data TIMESTAMP DEFAULT CURRENT_TIMESTAMP) ENGINE=InnoDB", (errordtb) => {        
        if(errordtb) throw errordtb
    })
