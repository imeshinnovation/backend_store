...
mariadb.createConnection({
    ...
    conexion.query("CREATE TABLE IF NOT EXISTS " + env.DATABASE + ".usuarios (id INT(11) PRIMARY KEY AUTO_INCREMENT, nombres VARCHAR(64) not null, apellidos VARCHAR(64) not null, email VARCHAR(128) not null UNIQUE, password VARCHAR(128) not null ) ENGINE=InnoDB ", (errordtb) => {
    ...
    console.log('Wey! que hiciste, mira lo que le paso con tu conec -> ', error.code)
})